...
urlpatterns = [
    ...
    path('strains-per-taxonomic-level/kingdom/', views.get_strains_by_kingdom_level),
    path('strains-per-taxonomic-level/phylum/', views.get_strains_by_phylum_level),
    path('strains-per-taxonomic-level/class/', views.get_strains_by_class_level),
    path('strains-per-taxonomic-level/order/', views.get_strains_by_order_level),
    path('strains-per-taxonomic-level/family/', views.get_strains_by_family_level),
    path('strains-per-taxonomic-level/genus/', views.get_strains_by_genus_level),
